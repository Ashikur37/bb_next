      ...
      <div className={`${bag.my_bag} mb-5`}>
        <div className="container">
          ...
          {props.cartItems.length > 0 ? (
            <div className="row">
              <div className={bag.mybag_details}>
                <div className={bag.mybag_left}>
                  <div className={bag.inbag_products}>
                    {props.cartItems.map((cartItem, index) => (
                      <div className={bag.bag_product} key={index}>
                        <CartItem
                    ...
                    {giftProduct && (
                      <div className={bag.gitProduct_row}>
                        <img src={giftProduct.image} />
                        <div className={bag.details_container}>
                          <div className={bag.name}>{giftProduct.name}</div>
                          <span>Free Gift</span>
                          <button
                        ...
                        <div className={bag.price}>QAR 00.00</div>
                      </div>
                    )}

                    <div className={bag.sub_total}>
                  ...
                  <div className={`${bag.deliviry_method_row} col  mt-3`}>
                    <ul>
                      <li
                        className={method == "store_pickup" ? bag.active : ""}
                        onClick={() => deliveryHandler("store_pickup")}
                      >
                        <div className={bag.method_checked}>
                          <FontAwesomeIcon icon={faCheck} />
                        </div>
                        <span className={bag.method_title}>
                          {t("Store pickup")}
                        </span>
                        <p className={bag.method_details}>{t("shop_address")}</p>
                      </li>
                      <li
                        className={method == "express" ? bag.active : ""}
                      ...
                      >
                        ...
                        <p className={bag.method_details}>{t("express note")}</p>
                      </li>
                      <li
                        className={method == "regular" ? bag.active : ""}
                      ...
                      >
                        ...
                        <p className={bag.method_details}>{t("d_info")}</p>
                      </li>
                    </ul>
                  </div>
                ...
                <div className={bag.mybag_right}>
                  <div className={`${bag.payment_group} mt-4`}>
                  ...
                  <div className={`${bag.summery} mb-2`}>
                    <div className={bag.item_title}>{t("ORDER SUMMARY")}</div>
                    <div className={bag.summery_items}>
                      <div className={bag.summery_item}>
                        <span className={bag.sub}>{t("ORDER SUB-TOTAL")}</span>
                      ...
                      <div className={bag.summery_item}>
                        <span className={bag.sub}>{t("SHIPPING")}*</span>
                        <span className={bag.amount}>{shipping}.00</span>
                      </div>
                      <div className={bag.summery_item}>
                        <span className={bag.sub}>{t("DISCOUNT")}</span>
                        <span className={bag.amount}>
                          {" "}
                          &#8722;{" "}
                          {flag
                      ...
                      <div className={`${bag.summery_item} ${bag.total}`}>
                        <span className={bag.sub}>{t("GRAND TOTAL")}</span>
                        <span className={bag.amount}>
                          {(
                      ...
                      <div className={bag.checkout_btn_container}>
                        {oos ? (
                    ...
                    {gifts &&
                      ...
                      gifts.map((itm, index) => (
                        <button
                          ...
                          className={`${bag.brand__offer__card} mb-2 px-2`}
                        >
                          <img
                            src={itm.files[0].thumbnail_image}
                            alt={itm.name}
                          />
                          <div className={bag.brand__name}>{itm.name}</div>
                          <div className={bag.rangePrice}>
