          ...
          <div className={styles.step_three}>
            ...
            <div className={styles.invoice}>
              ...
              <div className={styles.customer_info}>
                <ul>
                  <li>
                    <span className={styles.label}>{t("Customer Name")}:</span>{" "}
                    {customer_first_name}
                  </li>
                  {/* <li>
              <span className={styles.label}>Contact number:</span> 880 01971430000
            </li> */}
                  <li>
              ...
              <div className={styles.table_footer}>
                ...
                <div className={styles.right}>
                  <div className={`${styles.charge} ${styles.common}`}>
                    <span>{t("Delivery Charge")}</span>
                    <span>
                      {" "}
                      {store_pickup ? "00" : express ? 20 : props.shipping}.00
                    </span>
                  </div>

                  <div className={`${styles.grand_total} ${styles.common}`}>
                  ...
                  <div className={`${styles.payment_status} ${styles.common}`}>
