  ...
  return (
    <div className="container">
      <div className="step_zero">
        <div className="step_zero_title">{t("Please Choose a Checkout Method")}</div>
        <div className="methods">
          <div className="row">
            <div className="col-md-6">
              <div className="method_one">
            ...
            <div className="col-md-6">
              <div className="method_two">
                ...
                />
                <div className="phone_submit_wrapper">
                  <button
                    disabled={isValidPhoneNumber(value) ? false : true}
                    type="submit"
                    className="phone_proceed"
                    onClick={numberInput}
                  >
                    {t("Proceed")}
                  </button>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation("common")(StepZero));
