      ...
      <div className="container">
        <div className="row">
          <div className="col-md-8">
            <HeaderComponent text={t("address")} />
                ...
                <div className="row">
                  <div onChange={radioHandler} className="col-lg-6 ">
                    <div className="form-group">
                      ...
                      <div className="deleviry_schedule">
                        <div className="form-group info-wrap">
                          <span className="info">9AM - 1PM </span>
                          <label
                            htmlFor="morning"
                            className="input_label info_wrapper"
                          >
                            {t("Morning")}
                          </label>
                          <input
                        ...
                        <div className="form-group info-wrap">
                          <span className="info">4PM - 7PM </span>
                        ...
                        <div className="form-group info-wrap">
                          <span className="info">7PM - 10PM </span>
          ...
          <div className="col-md-4">
            ...
            <div className="cart_list">
              <div className="item_title">{t("Product Check")}</div>
            ...
            <div className="summery mb-2">
              ...
              <div className="summery_items">
                ...
                <div className="summery_item">
                  ...
                  <span className="amount">QAR {props.shipping}.00</span>
                </div>
